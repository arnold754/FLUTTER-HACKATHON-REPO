        ...
        trailing: Row(
          ...
          children: [
            IconButton(
              onPressed: () {
                onEditItem(
                    todo); // Invoke callback function when edit button is pressed, passing the ToDo object
              },
              icon: Icon(
                Icons.edit,
                size: 18,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 244, 107,
                    97), // Set background color of the delete button container to red
